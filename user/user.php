...
<?php 
    ...
    <header>
        <div class="nav container">
            ...
            <div class="nav-icons">
                <a href="#"><i class="bx"><?= $_SESSION['nama'] ?></i></a>
    ...
    <section class="book container" id="book">
        ...
        <div class="book-data">
            ...
            <form method="post" action="booking_aksi.php">
                <div class="input-box">
                    <i class="bx bx-user"></i>
                    <input type="text" name="nama_pemesan" placeholder="Nama Anda" id="">
                </div>
                <div class="input-box">
                    <i class="bx bx-phone-call"></i>
                    <input type="number" name="no_hp" placeholder="Nomor Anda" id="">
                </div>
                <button type="submit" class="book-btn">Booking Meja</button>
            </form>
