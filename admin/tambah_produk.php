                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Menambahkan Data di Tabel Produk</h6>
                            <div class="card-body">
                                ...
                                <form method="post" action="tambah_produk_aksi.php" enctype="multipart/form-data">
                                    <table>
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="number" name="harga_produk" class="form-control" placeholder="Masukkkan Harga Produk ... " required>
                                        </div>
                                        <div class="form-group mb-2">
                                            <label>Gambar</label>
