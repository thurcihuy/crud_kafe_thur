        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Pemesan</h1>
                    <?php
                    include '../config.php';
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi,"select * from pemesan where id_pemesan='$id'");
                    while($d = mysqli_fetch_array($data)){
                    ?>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Mengedit Data <?php echo $d['nama_pemesan']; ?></h6>
                            <div class="card-body">
                                <a href="pemesan.php" class="btn btn-primary" type="button"><i class="bi bi-box-arrow-in-left"></i> Kembali</a>
                                <br>
                                <br>
                                <form method="post" action="proses_edit_pemesan.php" enctype="multipart/form-data">
                                    <table>
                                        <div class="form-group mb-2">
                                            <label>Nama</label>
                                            <input type="hidden" name="id_pemesan" value="<?php echo $d['id_pemesan']; ?>">
