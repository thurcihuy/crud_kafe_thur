...
$get3 = mysqli_query($koneksi, "select * from pemesan");
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="bootstrap/img/undraw_posting_photo.svg" alt="...">
                                    </div>
                                    <p>Halaman ini berisi tentang informasi terkait Sistem dari website kafe. Sebagai
                                        Admin Anda akan bisa mengakses semua data informasi terkait tabel-tabel yang ada
                                        pada data base website ini.</p>
                                    <a target="_blank" rel="nofollow" href="#">Klik disini untuk pergi ke halaman
                                        tabel</a>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Informasi Lebih lanjut</h6>
                                </div>
                                <div class="card-body">
                                    <p>Halaman dasboard ini dikembangkan dengan html,js, css, php, & Boostrap sebagai
                                        Framework, dan juga elemen-elemen lainnya</p>
                                    <p class="mb-0">Semua data data dan informasi di halaman website ini dipertanggung
                                        jawabkan oleh si pembuat yaitu "Thur Liebert"</p>
                                </div>
                            </div>
