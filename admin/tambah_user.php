                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Menambahkan Data di Tabel User</h6>
                            <div class="card-body">
                                <a href="user.php" class="btn btn-primary" type="button"><i class="bi bi-box-arrow-in-left"></i> Kembali</a>
                                <br>
                                <br>
                                <form method="post" action="tambah_user_aksi.php">
                                    <table>
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" name="username" class="form-control" placeholder="Masukkkan Username Anda ... " required>
                                        </div>
                                        <div class="form-group mb-2">
                                        ...
                                        <label>Tipe User </label>
                                                <select name="level" class="form-control" required>
                                                    <option option value=""> Pilih Level User </option>
